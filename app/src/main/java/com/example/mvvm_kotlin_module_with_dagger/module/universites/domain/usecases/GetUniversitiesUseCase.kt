...
class GetUniversitiesUseCase (private val universitiesRepository: UniversitiesRepository) {
suspend fun execute():List<UniversitiesModel>? = universitiesRepository.getUniversities()
}